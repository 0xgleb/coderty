...
pub mod governor_settings {
    ...
    pub enum GovernorSettingsErrors {
        Empty(Empty),
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorSettingsErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorSettingsErrors {
    ...
    impl ::ethers::contract::ContractRevert for GovernorSettingsErrors {
    ...
    impl ::core::fmt::Display for GovernorSettingsErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<::std::string::String> for GovernorSettingsErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<Empty> for GovernorSettingsErrors {
        fn from(value: Empty) -> Self {
            Self::Empty(value)
        }
    }
    impl ::core::convert::From<InvalidShortString> for GovernorSettingsErrors {
        fn from(value: InvalidShortString) -> Self {
            Self::InvalidShortString(value)
        }
    }
    impl ::core::convert::From<StringTooLong> for GovernorSettingsErrors {
    ...
    impl ::ethers::contract::EthLogDecode for GovernorSettingsEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = Eip712DomainChangedFilter::decode_log(log) {
                return Ok(GovernorSettingsEvents::Eip712DomainChangedFilter(decoded));
            }
    ...
    impl ::core::convert::From<Eip712DomainChangedFilter> for GovernorSettingsEvents {
    ...
    impl ::core::convert::From<ClockModeCall> for GovernorSettingsCalls {
    ...
    impl ::core::convert::From<CancelCall> for GovernorSettingsCalls {
    ...
    impl ::core::convert::From<ClockCall> for GovernorSettingsCalls {
        fn from(value: ClockCall) -> Self {
            Self::Clock(value)
        }
    }
    impl ::core::convert::From<Eip712DomainCall> for GovernorSettingsCalls {
    ...
    impl ::core::convert::From<ProposalProposerCall> for GovernorSettingsCalls {
