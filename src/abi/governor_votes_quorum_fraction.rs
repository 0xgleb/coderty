pub use governor_votes_quorum_fraction::*;
...
pub mod governor_votes_quorum_fraction {
    ...
    pub static GOVERNORVOTESQUORUMFRACTION_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct GovernorVotesQuorumFraction<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for GovernorVotesQuorumFraction<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for GovernorVotesQuorumFraction<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for GovernorVotesQuorumFraction<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for GovernorVotesQuorumFraction<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(GovernorVotesQuorumFraction))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> GovernorVotesQuorumFraction<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    GOVERNORVOTESQUORUMFRACTION_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            GovernorVotesQuorumFractionEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for GovernorVotesQuorumFraction<M> {
    ...
    pub enum GovernorVotesQuorumFractionErrors {
        Empty(Empty),
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorVotesQuorumFractionErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorVotesQuorumFractionErrors {
    ...
    impl ::ethers::contract::ContractRevert for GovernorVotesQuorumFractionErrors {
    ...
    impl ::core::fmt::Display for GovernorVotesQuorumFractionErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for GovernorVotesQuorumFractionErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<Empty> for GovernorVotesQuorumFractionErrors {
        fn from(value: Empty) -> Self {
            Self::Empty(value)
        }
    }
    impl ::core::convert::From<InvalidShortString>
    for GovernorVotesQuorumFractionErrors {
        fn from(value: InvalidShortString) -> Self {
            Self::InvalidShortString(value)
        }
    }
    impl ::core::convert::From<StringTooLong> for GovernorVotesQuorumFractionErrors {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum GovernorVotesQuorumFractionEvents {
    ...
    impl ::ethers::contract::EthLogDecode for GovernorVotesQuorumFractionEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = Eip712DomainChangedFilter::decode_log(log) {
                return Ok(
                    GovernorVotesQuorumFractionEvents::Eip712DomainChangedFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalCanceledFilter::decode_log(log) {
                return Ok(
                    GovernorVotesQuorumFractionEvents::ProposalCanceledFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalCreatedFilter::decode_log(log) {
                return Ok(
                    GovernorVotesQuorumFractionEvents::ProposalCreatedFilter(decoded),
                );
            }
            if let Ok(decoded) = ProposalExecutedFilter::decode_log(log) {
                return Ok(
                    GovernorVotesQuorumFractionEvents::ProposalExecutedFilter(decoded),
                );
            }
            if let Ok(decoded) = QuorumNumeratorUpdatedFilter::decode_log(log) {
                return Ok(
                    GovernorVotesQuorumFractionEvents::QuorumNumeratorUpdatedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = VoteCastFilter::decode_log(log) {
                return Ok(GovernorVotesQuorumFractionEvents::VoteCastFilter(decoded));
            }
            if let Ok(decoded) = VoteCastWithParamsFilter::decode_log(log) {
                return Ok(
                    GovernorVotesQuorumFractionEvents::VoteCastWithParamsFilter(decoded),
                );
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for GovernorVotesQuorumFractionEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for GovernorVotesQuorumFractionEvents {
    ...
    impl ::core::convert::From<VoteCastFilter> for GovernorVotesQuorumFractionEvents {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum GovernorVotesQuorumFractionCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for GovernorVotesQuorumFractionCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for GovernorVotesQuorumFractionCalls {
    ...
    impl ::core::fmt::Display for GovernorVotesQuorumFractionCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<BallotTypehashCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: BallotTypehashCall) -> Self {
            Self::BallotTypehash(value)
        }
    }
    impl ::core::convert::From<ClockModeCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: ClockModeCall) -> Self {
            Self::ClockMode(value)
        }
    }
    impl ::core::convert::From<CountingModeCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: CountingModeCall) -> Self {
            Self::CountingMode(value)
        }
    }
    impl ::core::convert::From<ExtendedBallotTypehashCall>
    for GovernorVotesQuorumFractionCalls {
        fn from(value: ExtendedBallotTypehashCall) -> Self {
            Self::ExtendedBallotTypehash(value)
        }
    }
    impl ::core::convert::From<CancelCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: CancelCall) -> Self {
            Self::Cancel(value)
        }
    }
    impl ::core::convert::From<CastVoteCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: CastVoteCall) -> Self {
            Self::CastVote(value)
        }
    }
    impl ::core::convert::From<CastVoteBySigCall> for GovernorVotesQuorumFractionCalls {
    ...
    impl ::core::convert::From<ClockCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: ClockCall) -> Self {
            Self::Clock(value)
        }
    }
    impl ::core::convert::From<Eip712DomainCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: Eip712DomainCall) -> Self {
            Self::Eip712Domain(value)
        }
    }
    impl ::core::convert::From<ExecuteCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: ExecuteCall) -> Self {
            Self::Execute(value)
        }
    }
    impl ::core::convert::From<GetVotesCall> for GovernorVotesQuorumFractionCalls {
    ...
    impl ::core::convert::From<HasVotedCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: HasVotedCall) -> Self {
            Self::HasVoted(value)
        }
    }
    impl ::core::convert::From<HashProposalCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: HashProposalCall) -> Self {
            Self::HashProposal(value)
        }
    }
    impl ::core::convert::From<NameCall> for GovernorVotesQuorumFractionCalls {
    ...
    impl ::core::convert::From<ProposeCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: ProposeCall) -> Self {
            Self::Propose(value)
        }
    }
    impl ::core::convert::From<QuorumCall> for GovernorVotesQuorumFractionCalls {
    ...
    impl ::core::convert::From<QuorumNumeratorWithTimepointCall>
    for GovernorVotesQuorumFractionCalls {
        fn from(value: QuorumNumeratorWithTimepointCall) -> Self {
            Self::QuorumNumeratorWithTimepoint(value)
        }
    }
    impl ::core::convert::From<QuorumNumeratorCall>
    for GovernorVotesQuorumFractionCalls {
        fn from(value: QuorumNumeratorCall) -> Self {
            Self::QuorumNumerator(value)
        }
    }
    impl ::core::convert::From<RelayCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: RelayCall) -> Self {
            Self::Relay(value)
        }
    }
    impl ::core::convert::From<StateCall> for GovernorVotesQuorumFractionCalls {
    ...
    impl ::core::convert::From<TokenCall> for GovernorVotesQuorumFractionCalls {
    ...
    impl ::core::convert::From<VersionCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: VersionCall) -> Self {
            Self::Version(value)
        }
    }
    impl ::core::convert::From<VotingDelayCall> for GovernorVotesQuorumFractionCalls {
        fn from(value: VotingDelayCall) -> Self {
            Self::VotingDelay(value)
        }
    }
    impl ::core::convert::From<VotingPeriodCall> for GovernorVotesQuorumFractionCalls {
