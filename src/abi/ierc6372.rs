...
pub mod ierc6372 {
    ...
    pub static IERC6372_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    ...
    impl<M> ::core::fmt::Debug for IERC6372<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IERC6372)).field(&self.address()).finish()
        }
    }
